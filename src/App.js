...
function App() {
  ...
  return (
    <div className="h-screen w-screen flex justify-center items-center relative bg-amber-600 overflow-hidden">
      <div className='absolute top-0 bg-yellow-300 text-amber-600 py-1 w-full text-center text-[9px] font-custom'>CA: updating...</div>
      ...
      <div className='absolute top-7 right-3 flex items-center z-[50]'>
          <a href="https://x.com/" className='transition ease-in-out duration-150'>
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" className='w-10 h-10 md:w-12 md:h-12 md:hover:scale-105 transition ease-in-out duration-150 cursor-pointer' fill="yellow" viewBox="0 0 50 50">
